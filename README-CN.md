...
【[English](https://github.com/taxze6/Go-Chat-Craft/blob/master/README.md) | 中文文档】

客户端地址：https://github.com/taxze6/flutter-chat-craft

服务端地址：https://github.com/taxze6/Go-Chat-Craft

Android Apk体验地址（使用蒲公英内测，如果无法下载则表明达到了500次/天的限额）：

https://www.pgyer.com/XxRr8v
...
感谢帮助我制作这个视频的朋友。如果你也需要制作一个类似的视频，你可以通过这个电子邮件联系他:tjl2945428088@icloud.com
...
2.检查本地开发环境：确保您拥有 `3.16.9` 或更高版本的 Flutter 环境和`1.19.3`或更高版本的 golang。
